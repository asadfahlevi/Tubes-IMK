        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-center"><br>
                    <h2 class="title text-gray-800">Data Staff</h2>
                </div>
                <div class="card-body">
                    {{-- <div class="row"> --}}
                        <div class="box">
                        ...
                        <div class="box-body ">
                            ...
                            <form action="/staff/edit" method="POST">
                                ...
                                <table>
                                    <tr>
                                        <td> <label for="member_id">Staff ID </label> </td>
                                        <td>:</td>
                                        <td class="input">
                                            <input type="number" name="id" id="id" 
                                            min="0" value="{{ $user->id }}" required readonly="readonly"
                                    ...
                                    <tr>
                                        ...
                                        <td class="input">
                                            ...
                                            min="0" value="{{ $user->telp_no }}" required />
                                            <div class="invalid-feedback">
                                                @error('user_telpNo')
                                                {{$message}}
                                                @enderror
